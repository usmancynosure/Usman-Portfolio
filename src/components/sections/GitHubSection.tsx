...
function AnimatedNumber({ target, label }: { target: number; label: string }) {
  ...
  return (
    <div ref={ref} className="glass-card rounded-2xl p-4 sm:p-6 text-center hover:border-gold-500 hover:shadow-[0_4px_20px_rgba(59, 130, 246,0.2)] hover:-translate-y-1 transition-all duration-500">
