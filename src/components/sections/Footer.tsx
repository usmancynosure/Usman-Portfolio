  ...
  return (
    <footer className="relative bg-navy-950 border-t border-navy-700 py-12 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 text-center relative z-10">
        ...
        <p className="text-sm text-text-muted mt-2 tracking-wide">Crafting AI Solutions for Tomorrow</p>
        <div className="w-16 h-px bg-gradient-to-r from-transparent via-gold-500 to-transparent mx-auto my-5" />
