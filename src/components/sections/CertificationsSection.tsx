  ...
  return (
    ...
    >
      ...
      >
        {/* Front */}
        <div
          className="absolute inset-0 glass-card rounded-2xl overflow-hidden hover:border-gold-500 hover:shadow-[0_8px_30px_rgba(59, 130, 246,0.15)] transition-all duration-500"
