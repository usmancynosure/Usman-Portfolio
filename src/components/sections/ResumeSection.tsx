      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <div className="border-2 border-gold-500 rounded-2xl overflow-hidden relative bg-[linear-gradient(135deg,rgba(245,240,232,0.03),rgba(245,240,232,0.01))]"
            style={{
              backgroundImage: "linear-gradient(135deg, #3B82F6 6px, transparent 6px), linear-gradient(225deg, #3B82F6 6px, transparent 6px), linear-gradient(315deg, #3B82F6 6px, transparent 6px), linear-gradient(45deg, #3B82F6 6px, transparent 6px)",
