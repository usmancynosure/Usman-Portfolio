...
export const blogPosts: BlogPost[] = [
  {
    id: "product-engineering-for-ai",
    title: "Product Engineering for AI: Why Shipping Beats Modeling",
    excerpt: "Most AI projects die between the notebook and the user. Here's how I think about scoping, latency budgets, and fallback states so a model actually becomes a product.",
    date: "May 2026",
    readTime: "6 min read",
    icon: "🚀",
  ...
  {
    id: "ai-products-not-demos",
    title: "Designing AI-Powered Products That Don't Feel Like Demos",
    excerpt: "Streaming, optimistic UI, graceful degradation, and trust signals — the UX patterns that turn an LLM call into a product users actually rely on.",
    date: "Apr 2026",
    readTime: "8 min read",
    icon: "✨",
    category: "AI Products",
  ...
  {
    id: "agentic-ai-in-production",
    title: "Agentic AI in Production: From LangGraph Demos to Real Reliability",
    excerpt: "What it actually takes to run agents in prod — memory budgets, retry strategies, human-in-the-loop checkpoints, and observability you can debug at 2am.",
    date: "Mar 2026",
    readTime: "9 min read",
    icon: "🤖",
    category: "Agentic AI",
  ...
  {
    id: "the-agentic-stack",
    title: "The Agentic Stack: Tools, Memory, and the Loop",
    excerpt: "A breakdown of the components every agent needs — tool registries, scratchpads, working memory vs. long-term memory, and how to keep the planning loop from running away.",
    date: "Feb 2026",
    readTime: "7 min read",
    icon: "🧩",
    category: "Agentic AI",
  ...
  {
    id: "shipping-with-claude-code-cursor",
    title: "Shipping Faster with Claude Code & Cursor: My Agentic Dev Workflow",
    excerpt: "How I use Claude Code and Cursor day-to-day to compress build cycles — from spec to PR — without dropping quality. Hooks, MCP, slash commands, and the prompts that actually move the needle.",
    date: "Jan 2026",
  ...
  {
    id: "idea-to-prod-7-days",
    title: "From Idea to Prod in 7 Days: An AI Product, End-to-End",
    excerpt: "Walkthrough of taking an AI-powered product from a one-pager to a deployed app in a week — product spec, system design, agentic build, deploy, and the things I'd do differently.",
    date: "Dec 2025",
